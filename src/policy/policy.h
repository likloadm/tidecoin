...
static const unsigned int DEFAULT_MAX_MEMPOOL_SIZE = 512;
...
static const unsigned int MAX_STANDARD_P2WSH_STACK_ITEM_SIZE = 1000;
/** The maximum size of a standard witnessScript */
static const unsigned int MAX_STANDARD_P2WSH_SCRIPT_SIZE = 100000;
