...
UniValue generateBlocks(std::shared_ptr<CReserveScript> coinbaseScript, int nGenerate, uint64_t nMaxTries, bool keepScript)
{
    ...
    while (nHeight < nHeightEnd && !ShutdownRequested())
    {
        ...
        BlockSet sForkTips;
        if (!ProcessNewBlock(Params(), shared_pblock, true, nullptr, postponeRelay, sForkTips))
        ...
        throw std::runtime_error(
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated tidecoin to."},
            ...
            + "If you are running the tidecoin core wallet, you can get a new address to send the newly generated tidecoin to with:\n"
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    bool postponeRelay = false;
    BlockSet sForkTips;
    bool accepted = ProcessNewBlock(Params(), blockptr, /* fForceProcessing */ true, /* fNewBlock */ &new_block, postponeRelay, sForkTips);
