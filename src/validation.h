 ...
 * validationinterface callback.
 */
bool ActivateBestChain(CValidationState& state, const CChainParams& chainparams, bool &postponeRelay, std::shared_ptr<const CBlock> pblock = std::shared_ptr<const CBlock>());
